			...
			<DialogContent>
				...
				<form onSubmit={handleAddTask} className="space-y-4">
					...
					<div className="flex items-center justify-between">
						...
						<Button type="submit" disabled={loading} className="bg-primary-600 text-white hover:bg-primary-700">
										...
										<div className="flex-1 min-w-0">
											...
											<div className="mt-2 flex items-center gap-2">
												...
												{task.urgent && !task.done && (
													<span className="px-2 py-0.5 text-xs bg-red-50 text-red-600 rounded-full">Urgent</span>
												)}
											</div>
										</div>
