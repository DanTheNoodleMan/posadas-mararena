...
export const metadata: Metadata = {
  ...
  description: "Posadas de lujo frente al mar en Chirimena-Higuerote. Vista al Mar e Inmarcesible ofrecen 17 habitaciones con piscinas infinity, churuatas tradicionales y espacios para eventos. A 2 horas de Caracas.",
  ...
  openGraph: {
    ...
    description: "Posadas de lujo frente al mar en Chirimena-Higuerote. Piscinas infinity, churuatas tradicionales y espacios para hasta 31 huéspedes. Perfecto para familias y eventos especiales.",
    images: [
      {
