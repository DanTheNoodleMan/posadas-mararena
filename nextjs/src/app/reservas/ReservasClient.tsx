...
import { Check, ArrowRight, ArrowLeft, Loader2, Users as UsersIcon, AlertCircle, CheckCircle } from "lucide-react";
					...
					{paso === 5 && codigoReserva && (
						<div className="bg-neutral-100 p-8 rounded-sm text-center">
							...
							<div className="mb-8">
								...
								<div className="bg-amber-50 border-2 border-amber-400 p-4 rounded-sm max-w-xl mx-auto">
									<p className="text-amber-900 font-semibold text-sm flex items-center justify-center gap-2">
							...
							<div className="space-y-4 text-left max-w-xl mx-auto mb-8">
								<div className="bg-white p-4 rounded-sm border border-neutral-300">
									<h3 className="font-semibold text-primary-600 mb-3 flex items-center gap-2">
